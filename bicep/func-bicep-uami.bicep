param uniquekey string = 'nemehpet'     // Put a name distinguisher here, unique key or so
param storageAccountName string = 'stnemehpetmwfg'

param container string = 'monitoring'
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: funcapp_name_resource.properties.clientId
        }
        {
