  ...
  storageaccounts = {
    ...
    tfcustm = {
      ...
      network_rules = {
        ...
        virtual_network_subnet_ids = [
          module.virtual_network.monitoring.subnets.subnet1.resource_id,
          module.virtual_network.monitoring.subnets.subnet0.resource_id
        ]
      }
      containers = {
        monitoring = {
      ...
      # private_endpoints = {
      #   blob = {
      #     name                          = "${local.uniquekey}blob-endpoint"
      #     subresource_name              = "blob"
      #     subnet_resource_id            = module.virtual_network.monitoring.subnets.subnet1.resource_id
      #     private_dns_zone_resource_ids = [module.private_dns_zone["blob"].resource_id]
      #   }
      # }
    }
    tfazapi = {
